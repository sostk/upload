...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lcom/flyme/internal/R$drawable;->lock_digit_background_light:I
    ...
    sget v1, Lcom/flyme/internal/R$dimen;->mz_draw_radio:I
    ...
    sget v1, Lcom/flyme/internal/R$dimen;->mz_circle_icon_radio:I
    ...
    sget v1, Lcom/flyme/internal/R$dimen;->mz_lock_digit_textsize:I
...
.method private canAdd2Pattern(II)Z
    ...
    .line 777
    .local v1, "key":I
    iget-object v2, p0, Lcom/meizu/widget/LockDigitView;->mCellInfoArray:Landroid/util/SparseArray;
    ...
    .line 779
    iget-object v2, v0, Lcom/meizu/widget/LockDigitView$CellInfo;->icon:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_0

    iget-object v2, v0, Lcom/meizu/widget/LockDigitView$CellInfo;->label:Ljava/lang/String;
...
.method private getDefaultIcon(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Lcom/flyme/internal/R$array;->lock_digit_icons_light:I
...
.method private notifyCellAdded()V
    ...
    .line 280
    :cond_0
    const-string/jumbo v0, "lockscreen_access_pattern_cell_added"
...
.method private notifyPatternCleared()V
    ...
    .line 301
    :cond_0
    const-string/jumbo v0, "lockscreen_access_pattern_cleared"
...
.method private notifyPatternDetected()V
    ...
    .line 294
    :cond_0
    const-string/jumbo v0, "lockscreen_access_pattern_detected"
...
.method private notifyPatternStarted()V
    ...
    .line 287
    :cond_0
    const-string/jumbo v0, "lockscreen_access_pattern_start"
...
.method private sendAccessEvent(Ljava/lang/String;)V
    ...
    .line 558
    invoke-virtual {p0, v4}, Lcom/meizu/widget/LockDigitView;->setContentDescription(Ljava/lang/CharSequence;)V
...
.method private shouldSpeakPasswordForAccessibility()Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/meizu/widget/LockDigitView;->mAudioManager:Landroid/media/AudioManager;
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    .line 857
    .local p1, "animation":Landroid/animation/Animator;
    const/4 v0, 0x0
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/meizu/widget/LockDigitView;->resolveMeasured(II)I

    move-result v3

    .line 371
    .local v3, "viewWidth":I
    invoke-direct {p0, p2, v0}, Lcom/meizu/widget/LockDigitView;->resolveMeasured(II)I

    move-result v2

    .line 376
    .local v2, "viewHeight":I
    invoke-virtual {p0, v3, v2}, Lcom/meizu/widget/LockDigitView;->setMeasuredDimension(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 484
    iget-boolean v0, p0, Lcom/meizu/widget/LockDigitView;->mInputEnabled:Z
